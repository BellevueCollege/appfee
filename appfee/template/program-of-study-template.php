													...
													<div class="input-container">
														...
														<div class="conditional-group form-group" id="proftech_type">
															...
															<select class="form-control" id="proftech_type_selector" name="proftech_type" aria-required="true" required>
																...
																<option value="391C">Allied Health: Emergency Department Technician - 52 Credit Certificate Program </option>
																...
																<option value="527L">Network Services &amp; Computing Systems-Network Administration - 93 Credit AA Program </option>
																<option value="527K">Network Services &amp; Computing Systems-Operating Systems Administration - 93 Credit AA Program </option>
																...
																<option value="527S">Network Services/Cloud Architecture 93 Credit AA Program </option>

											...
											<div class="input-container">
												...
												<div class="conditional-group form-group">
													...
													<div class="input-container">
														<div class="radio">
															<label>
																<input type="radio" name="what_degree" id="what_degree_trans" value="AAD" aria-describedby="which_degree_heading" required>Transfer Degree
															</label>
													...
													<div class="input-container">
														...
														<div class="conditional-group form-group" id="proftech_type">
															...
															<select class="form-control" id="proftech_type_selector" name="proftech_type" aria-required="true" required>
																...
																<option value="505B">Accounting: Accounting Information Systems - 30 Credit Certificate Program</option>
																...
																<option value="505G">Accounting: Financial Data Report Specialist - 30 Credit Certificate Program </option>
																<option value="437">Alcohol &amp; Drug Counseling - 50 Credit Certificate Program </option>
																...
																<option value="310C">Allied Health: Clinical Lab Assistant - 50-59 Credit Certificate Program </option>
																<option value="391A">Allied Health: Emergency Department Technician - 44 Credit Certificate Program </option>
																<option value="391C">Allied Health: Emergency Department Technician - 52-61 Credit Certificate Program </option>
																<option value="532D">Allied Health: Health Unit Coordinator - 63-72 Credit Certificate Program </option>
																...
																<option value="312A">Allied Health: Medical Administrative Assistant - 48-57 Credit Certificate Program </option>
																<option value="382D">Allied Health: Phlebotomy Technician - 43-52 Credit Certificate Program </option>
																<option value="393C">Breast Ultrasound - 8-11 Credit Certificate Program (Limited or No Financial Aid) </option>
																...
																<option value="502B">Business Management: Project Management–General Business - 18-30 Credit Certificate Program (Limited or No Financial Aid) </option>
																<option value="547D">Business Technology - Web Marketing Specialist - 53 Credit Certificate Program </option>
																...
																<option value="518C">Business Technology: Advanced Business Technology Specialist - 46-48 Credit Certificate Program </option>
																...
																<option value="518B">Business Technology: Technology Specialist - 30-31 Credit Certificate Program </option>
																...
																<option value="503P">Information Systems: Intermediate Business Intelligence Analyst - 30 Credit Certificate Program </option>
																...
																<option value="245A">Marketing: Sales &amp; Marketing - 35 Credit Certificate Program </option>
																...
																<option value="527R">Network Services and Computing Systems - Network Administration - 93 Credit AAS-T Program </option>
																<option value="527Q">Network Services and Computing Systems - Operating System - 93 Credit AAS-T Program </option>
																<option value="527U">Network Services/Cloud Architecture 93 Credit AAS-T Program </option>
																...
																<option value="887">Occupational and Life Skills - 90 Credit AOLS Program</option>
																...
																<option value="354">Radiologic Technology - 104-105 Credit AA Program </option>
